...
<div id="<portlet:namespace/>details">
	<h4 class="aui-toggler-header-expanded header"><span>Information</span></h4>
	<div class="aui-toggler-content-expanded content">
	...
	<h4 class="aui-toggler-header-collapsed header"><span>Preferences</span></h4>
	<div class="aui-toggler-content-collapsed content">
	...
	<h4 class="aui-toggler-header-collapsed header"><span>Events</span></h4>
	<div class="aui-toggler-content-collapsed content">
	...
	<h4 class="aui-toggler-header-collapsed header"><span>Render Parameters</span></h4>
	<div class="aui-toggler-content-collapsed content">
	...
	<h4 class="aui-toggler-header-collapsed header"><span>Custom Fields</span></h4>
	<div class="aui-toggler-content-collapsed content">
